"""
Django settings for obe_software project.
...
SECRET_KEY = 'django-insecure-5-^ixt=)3(w0hbm4bfbmw^+pd1)s(yp*k7%!jiqrsku#+0r_%a'
...
WSGI_APPLICATION = 'obe_software.wsgi.application'
